...
/* ./.libs/lt-gridlabd.c - temporary wrapper executable for .libs/gridlabd.exe
   Generated by libtool (GNU libtool) 2.4

   The gridlabd program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\opt\\windows_64\\mingw\\bin\\lib;C:\\MinGW\\msys\\1.0\\opt\\windows_64\\mingw\\bin\\bin;";
const char * TARGET_PROGRAM_NAME = "gridlabd.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gridlabd - temporary wrapper script for .libs/gridlabd.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The gridlabd program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gridlabd.exe:gridlabd:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gridlabd.exe:gridlabd:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gridlabd.exe:gridlabd:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/opt/windows_64/mingw/bin/lib:/opt/windows_64/mingw/bin/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
